package com.blinx.demo.binxresourceserver.users.restcontrollers.testconfig;
...
public class RepoTestConfig {
	...
	public EntityManagerFactory entityManagerFactory() {
		...
		factory.setPackagesToScan(UserDetails.class.getPackage().getName(), Address.class.getPackage().getName());
